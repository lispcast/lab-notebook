...
return (new CustomEvent(event_name,(function (){var obj26930 = ({"detail":data});
return obj26930;
})()));
} else {
...
var f = (function (){var pred__26937 = cljs.core._EQ_;
var expr__26938 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26937.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26938))){
return ((function (pred__26937,expr__26938){
return (function (p1__26931_SHARP_){
return console.warn(p1__26931_SHARP_);
});
;})(pred__26937,expr__26938))
} else {
if(cljs.core.truth_(pred__26937.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26938))){
return ((function (pred__26937,expr__26938){
return (function (p1__26932_SHARP_){
return console.debug(p1__26932_SHARP_);
});
;})(pred__26937,expr__26938))
} else {
if(cljs.core.truth_(pred__26937.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26938))){
return ((function (pred__26937,expr__26938){
return (function (p1__26933_SHARP_){
return console.error(p1__26933_SHARP_);
});
;})(pred__26937,expr__26938))
} else {
return ((function (pred__26937,expr__26938){
return (function (p1__26934_SHARP_){
return console.log(p1__26934_SHARP_);
});
;})(pred__26937,expr__26938))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26941){
...
var eval_fn = cljs.core.get.call(null,map__26942__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26944_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__26946,(0),null);
var v = cljs.core.nth.call(null,vec__26946,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1551192011525
